...
function GhostCard() {
  return (
    <div role="status" className="w-full p-4 mb-6 space-y-4 h-[250px] border border-gray-200 divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700">
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-2xl px-1">
        <div className="rounded-lg border border-[#232325] bg-background mt-6 p-6">
        ...
        {showSecondBox === 'true'
          ? <div className="rounded-lg border mt-6 bg-background p-2">

            <div className='h-3/20 flex pb-2 w-full'>
              <div className='flex justify-start w-1/2'>

              </div>
              <div className='flex justify-end w-1/2'>
                <button className='border border-zinc-700 text-md rounded-md font-medium'
                  onClick={(e: React.MouseEvent<HTMLButtonElement>) => fetchData(1).then(() => {
                    // Execute logic after generate Promise resolves
                  }).catch(error => {
                    // Handle error here
                  })}>
